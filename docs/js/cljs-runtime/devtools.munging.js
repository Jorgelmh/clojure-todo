...
var o30601 = temp__5733__auto__;
var temp__5733__auto____$1 = (o30601["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o30602 = temp__5733__auto____$1;
return (o30602["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28232__auto__ = f;
return (o__28232__auto__["toString"]).call(o__28232__auto__);
} else {
return "";
}
...
try{var o__28232__auto___30682 = t;
(o__28232__auto___30682["cljs$lang$ctorPrWriter"]).call(o__28232__auto___30682,t,writer);
}catch (e30604){var __30683 = e30604;
}
...
var char_code = (function (){var o__28232__auto__ = (new String(char$));
return (o__28232__auto__["charCodeAt"]).call(o__28232__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28232__auto__ = String;
return (o__28232__auto__["fromCharCode"]).call(o__28232__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30605 = num_code;
switch (G__30605) {
case (1):
return (185);
...
var o__28232__auto__ = String;
return (o__28232__auto__["fromCharCode"]).call(o__28232__auto__,superscript_code);
});
/**
...
}catch (e30606){var _e__28244__auto__ = e30606;
return false;
}})())){
...
var vec__30607 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30607,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30612){
var vec__30613 = p__30612;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30613,(0),null);
...
var G__30688 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30689 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30688;
remaining_tokens = G__30689;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30610){
var G__30611 = cljs.core.first(seq30610);
var seq30610__$1 = cljs.core.next(seq30610);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30611,seq30610__$1);
}));
...
var vec__30618 = cljs.core.split_with((function (p1__30617_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30617_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30618,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30618,(1),null);
...
var vec__30624 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30624,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30624,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30697 = cljs.core.rest(remaining_tokens);
var G__30698 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30697;
name_tokens = G__30698;
continue;
} else {
...
var vec__30629 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30629,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30629,(1),null);
var vec__30632 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30632,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30632,(1),null);
var vec__30635 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30635,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30635,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30635,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30635,(3),null);
...
var vec__30640 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30640,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30640,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30640,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30640,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30640,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30640,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__30643 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30643,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30643,(1),null);
var vec__30646 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30646,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30646,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30649 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30649) : devtools.munging.parse_fn_info_deep.call(null,G__30649));
})()));
}
} else {
return fn_info;
...
var G__30708 = (arity + (1));
var G__30709 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30650){
var vec__30651 = p__30650;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30651,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30651,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30654_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30654_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30655_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30655_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30658){
var vec__30659 = p__30658;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30659,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30656){
var G__30657 = cljs.core.first(seq30656);
var seq30656__$1 = cljs.core.next(seq30656);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30657,seq30656__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30663__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30663__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30663__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30663__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30664 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30664,(5),null);
...
var o__28232__auto__ = f;
return (o__28232__auto__["getBasis"]).call(o__28232__auto__);
});
/**
...
}catch (e30668){var _e__28244__auto__ = e30668;
...
var G__30717 = (obj[cljs.core.first(path)]);
var G__30718 = cljs.core.rest(path);
obj = G__30717;
path = G__30718;
continue;
} else {
...
var _STAR_ = (function (accum,p__30669){
var vec__30670 = p__30669;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30670,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30670,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30673){
var vec__30674 = p__30673;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30674,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30674,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30674,(2),null);
...
var post_process = (function (p__30678){
var vec__30679 = p__30678;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30679,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30679,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30677_SHARP_){
return (obj[cljs.core.first(p1__30677_SHARP_)]);
}),sorted_matches);
