...
var G__30716 = devtools.prefs.pref(v);
v = G__30716;
continue;
} else {
return v;
...
}catch (e30693){var _e__28244__auto__ = e30693;
return false;
}})();
...
}catch (e30699){var _e__28244__auto__ = e30699;
return false;
}})();
...
}catch (e30702){var _e__28244__auto__ = e30702;
return false;
}}
}
});
...
var vec__30705 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30705,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30705,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30710_SHARP_);
}),template);
});
