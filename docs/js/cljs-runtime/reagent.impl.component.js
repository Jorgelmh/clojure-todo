...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__39235 = c;
var G__39235__$1 = (((G__39235 == null))?null:G__39235.prototype);
if((G__39235__$1 == null)){
return null;
} else {
return G__39235__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__39237 = c;
var G__39237__$1 = (((G__39237 == null))?null:G__39237.prototype);
if((G__39237__$1 == null)){
return null;
} else {
return G__39237__$1.render;
}
})() == null)))));
});
...
var or__4126__auto__ = (function (){var G__39243 = c;
var G__39243__$1 = (((G__39243 == null))?null:G__39243.constructor);
if((G__39243__$1 == null)){
return null;
} else {
return G__39243__$1.displayName;
}
})();
...
var G__39244 = c;
var G__39244__$1 = (((G__39244 == null))?null:G__39244.constructor);
if((G__39244__$1 == null)){
return null;
} else {
return G__39244__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__39245 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__39246 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__39246);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__39245);
}});
...
var c = this;
var G__39292_39334 = goog.object.get(c,"cljsRatom");
if((G__39292_39334 == null)){
} else {
reagent.ratom.dispose_BANG_(G__39292_39334);
}
...
var renders_39335 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_39336 = cljs.core.first(cljs.core.vals(renders_39335));
...
if((cljs.core.count(renders_39335) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_39335))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_39336)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_39336], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__39318 = o;
goog.object.set(G__39318,cljs.core.name(k),v);
